...
print("Ano   Salário")
print("--------------")
print(f" 1{salarioInicial:12.2f}")

salarioCorrecao = salarioInicial

for ano in range(2, anosCronograma + 1):
    aumento = salarioInicial * (percentualAumento / 100)
    salarioCorrecao += aumento
    print(f"{ano:2d}{salarioCorrecao:12.2f}")'''
